...
require('org.pinf.genesis.lib').forModule(require, module, function (API, exports) {
	...
	return FIRENODE.for(API).then(function (FIRENODE) {
		...
		// TODO: Fill this config dynamically by looking at API schema and
		//       security files for each backend route in `./stores`.
		var firenode = new FIRENODE.Server({
			"config": {
				"db": {
					"dbname": "dev DB!!"
				}
			...
			"hosts": {
				"lunchroom-stage.goodybag.com.local": {
					"config": {
						"clientContext": {
							"type": "lunchroom",
							"skinUri": "/dev\.skin\.style\.css"
						}
					},
					"routes": {
						"/bazaarvoice$": {
							"config": {
								"clientContext": {
									"skinUri": "/landing\.skin\.style\.css"
								}
							}
						},
						"/admin": {
